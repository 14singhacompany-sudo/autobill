        ...
        <Card>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <CustomerBranchSelector value={formData.customer_branch_code} onChange={(value) => updateField("customer_branch_code", value)} readOnly={readOnly} name="receipt_customer_branch_type" />
            </div>
